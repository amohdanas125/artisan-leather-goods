    ...
    <footer className="bg-ink text-ink-foreground">
      <div className="mx-auto max-w-7xl px-4 py-14">
        <div className="grid gap-10 lg:grid-cols-4">
          <div>
            <span className="font-display text-2xl font-extrabold text-white">Terracotta</span>
            ...
            <div className="mt-5 flex gap-3">
              <a
                ...
                className="flex h-9 items-center gap-2 rounded-lg border border-ink-foreground/25 px-3 text-xs cursor-pointer hover:border-white hover:text-white transition-colors"
              >
          ...
          <div>
            <h3 className="text-sm font-bold uppercase tracking-wider text-white">My Account</h3>
            <ul className="mt-4 space-y-2.5 text-sm text-ink-foreground/70">
              <li>
                <button
                  type="button"
